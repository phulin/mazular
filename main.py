...
while True:
	...
	while not pygame.event.peek(KEYDOWN):
		...
		controls = SMALL_FONT.render("wasd control the left player, arrow keys control the right player", True, (102, 205, 170))
		...
		controls2 = SMALL_FONT.render("esc to exit, F5 to reset", True, (102, 205, 170))
		textRect22 = controls.get_rect()
		textRect22.centerx = SURFACE.get_rect().centerx + 200
		textRect22.centery = SURFACE.get_rect().centery+125
		SURFACE.blit(controls2,textRect22)
